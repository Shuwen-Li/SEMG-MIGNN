...
def add_o(num_ori,num_replace,index2,index1):
    if num_ori<0:
        if num_replace<0:
            tem_o=' '*(index2-index1-1)
        else:
            tem_o=' '*(index2-index1+1-1)            
    else:
        if num_replace<0:
            tem_o=' '*(index2-index1-1-1)
        else:
...
def add_o_o(ele,num_ori,num_replace,index2,index1):
    if len(ele)==1:
        add_o=0
    elif len(ele)==2:
        add_o=-1
    ...
    if num_ori<0:
        if num_replace<0:
            tem_o=' '*(index2-index1-1+add_o)
        else:
            tem_o=' '*(index2-index1+1-1+add_o)            
    else:
        if num_replace<0:
            tem_o=' '*(index2-index1-1-1+add_o)
        else:
